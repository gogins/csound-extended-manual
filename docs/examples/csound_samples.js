  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'csound_samples.data';
      var REMOTE_PACKAGE_BASE = 'csound_samples.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_csound_samples.data');

      };
      Module['addRunDependency']('datafile_csound_samples.data');
